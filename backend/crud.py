...
async def get_user_by_telegram(db: AsyncSession, telegram_id: int):
    # Игнорируем анонимизированных пользователей (telegram_id IS NULL)
...
async def admin_delete_user(db: AsyncSession, user_id: int, admin_user: models.User):
    ...
    user_to_anonymize.telegram_id = None  # Устанавливаем NULL для анонимизированных пользователей
