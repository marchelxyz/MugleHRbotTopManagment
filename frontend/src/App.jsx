...
// --- НАЧАЛО ИЗМЕНЕНИЙ ---
    ...
    // Устанавливаем ВСЕ системные цвета в ваш новый фон
    // Это создает эффект "прозрачности" и "полного экрана"
    const seamlessColor = "#418300";
    tg.setBackgroundColor(seamlessColor);
    tg.setHeaderColor(seamlessColor); 
